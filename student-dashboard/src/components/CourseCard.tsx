...
function CourseCard({ name, progress }: CourseCardProps) {
  ...
  return (
    <div className="group relative w-84 mt-15 ml-15
      ...
      <div className="absolute -top-7 left-6 w-4/5 h-2 bg-orange-300 rounded-full z-0"></div>

      {/* orange line vertical */}
      <div className = "absolute -left-7 w-2 h-4/5 bg-orange-300 rounded-full"/>

      {/* MAIN CARD */}
      <div className="relative z-10 bg-[#362A5A] p-8 rounded-2xl border-3 border-[#1F1C3D]
